  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="博主账号" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="博主姓名" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="管理账号" class="input" v-if="tableName=='putongguanliyuan'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='putongguanliyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="管理姓名" class="input" v-if="tableName=='putongguanliyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.bozhuzhanghao) && `yonghu` == this.tableName){
      ...
      if((!this.ruleForm.bozhuxingming) && `yonghu` == this.tableName){
